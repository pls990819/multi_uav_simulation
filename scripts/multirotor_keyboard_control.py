...
if __name__=="__main__":
    ...
    formation_configs = ['triangle','triangle','line']
    ...
    if control_type == 'vel':
        """
        velocity controller subscribers and publishers
        """
        ...
        """
        acceleration controller subscribers and publishers
        """
    ...
    while(1):
        """
        The main thread sends data to the UAV according to keyboard input
        """
        key = getKey()
        if key == 'w' : # forward
        ...
        elif key == 'i' : # increase upward velocity
        ...
        elif key == ',' : # decrease upward velocity
            upward = upward - LINEAR_STEP_SIZE
            print_msg()
            if control_type == 'vel':
                print("currently:\t forward vel %.2f\t leftward vel %.2f\t upward vel %.2f\t angular %.2f " % (forward, leftward, upward, angular))
        ...
        elif key == 'j': # increase orientation
            angular = angular + ANG_VEL_STEP_SIZE
            print_msg()
            print("currently:\t forward vel %.2f\t leftward vel %.2f\t upward vel %.2f\t angular %.2f " % (forward, leftward, upward, angular))

        elif key == 'l': # decrease orientation
            angular = angular - ANG_VEL_STEP_SIZE
            print_msg()
            print("currently:\t forward vel %.2f\t leftward vel %.2f\t upward vel %.2f\t angular %.2f " % (forward, leftward, upward, angular))

        elif key == 'r': # return home
            cmd = 'AUTO.RTL'
            print_msg()
